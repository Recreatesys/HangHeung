...
class PosSession(models.Model):
    ...
    def _create_coupon_adjustment_move(self):
        ...
        if not accounts:
            return
        acc_240001, acc_240002, acc_400010 = accounts

        balances = defaultdict(float)
        for order in self._get_closed_orders():
            for line in order.lines:
                self._collect_coupon_adjustment_for_line(
                    line, balances, acc_240001, acc_240002, acc_400010,
                )
    ...
    def _get_coupon_accounts(self):
        ...
        if not (acc_240001 and acc_240002 and acc_400010):
            return None
        return acc_240001, acc_240002, acc_400010

    def _collect_coupon_adjustment_for_line(self, line, balances, acc_240001, acc_240002, acc_400010):
